...
do
echo "******** $region"
verify_precip.py 20020101 20211229 $data_names_flag $temporal_res_flag $stats_flags $write_to_nc_flag $plot_flag --region $region >& ~/std_out/verify_precip.cmaps_timeseries.${region}.out
done
